        ...
        <div>
            <div className='pages_ser_main'>
                ...
                <div className='container'>
                    ...
                    <div className='row'>
                        {
                            CONSTANTS.CONTACT_US.PART_2.map((data) => {
                                return (
                                    <div className='col-12 col-md-4 d-flex flex-column justify-content-center align-items-center p-5'>
                                        <img src={data.Img}></img>
                                        <h3 className='py-3'>{data.Heading}</h3>
                                        {data?.value === "array" ?
                                            (
                                                <span className='text-center'>
                                                    <span>Info <spna className="text-primary">{data.Details[0]}</spna> </span> <br />
                                                    <span>Sales <spna className="text-primary">{data.Details[1]}</spna> </span>
                                                </span>
                                            )
                                            :
                                            <span className='text-center'>
