            ...
            <div className='services_Main'>
                <div className='service_us_image'>
                    <div className=' text-center text-light'>
                        <h1>{CONSTANTS.SERVICE_DATA.HARDWARE.Slider_Heading}</h1>
                        <p>{CONSTANTS.SERVICE_DATA.HARDWARE.Slider_Heading_Details}</p>
                    </div>
                </div>
                <div className='container'>
                    <div className='text-center mt-4'>
                        <h1 className='p-0 m-0'>{CONSTANTS.SERVICE_DATA.HARDWARE.PART_1.Heading}</h1>
                        <span className='heading_border'></span>
                        <p className='m-0 text-muted'>{CONSTANTS.SERVICE_DATA.HARDWARE.PART_1.Heading_Details}</p>
                    </div>
                    <div>
                        <Tab.Container id="left-tabs-example" defaultActiveKey="first">
                            <Row className='d-flex'>
                                <Nav variant="pills" className="flex-row justify-content-center">
                                    {
                                        CONSTANTS.SERVICE_DATA.HARDWARE.PART_2.map((data) => {
                                            return (
